...
import com.assignment.rest.entity.*;
import com.assignment.rest.repository.*;
import com.assignment.rest.utility.Encrypt;
import com.assignment.rest.utility.Validate;
    ...
    public void checkout(Long customerId) {
        ...
        if(activeCartByCustomerId != null){
            ...
            for(Cart cart : activeCartByCustomerId){
                ...
                String notificationMessageCustsomer =
                         cart.getDish().getDishName() + " " +"of quantity " +cart.getQuantity() +  "  successfully placed " ;

                CustomerNotification customerNotification = CustomerNotification.builder()
                        .customer(cart.getCustomer())
                        .notificationMessage(notificationMessageCustsomer)
                        .notificationTime(LocalDateTime.now())
                        .build();
